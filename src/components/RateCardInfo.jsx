...
export function RateCardInfo({ rateCard, pricingType = 'Variable', onEditTier, onDeleteTier }) {
            ...
            <React.Fragment key={t.id}>
              <div className="rate-row">
                ...
                <div className="rate-row-actions">
                  ...
                  <button className="btn-delete-tier" onClick={() => onDeleteTier && onDeleteTier(t)}>Delete</button>
                </div>
              </div>
